...
| I | Data Agent | PDF import, OCR, content conversion, worksheet parsing, data pipelines |
...
Use the agent letter or feature area: `(A)`, `(R)`, `(D)`, `(F)`, `(S)`, `(P)`, `(dashboard)`, `(grading)`, `(questions)`, etc.
