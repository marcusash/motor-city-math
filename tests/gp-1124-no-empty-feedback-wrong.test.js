// gp-1124-no-empty-feedback-wrong.test.js
// feedback_wrong must not be empty in any question.
...
console.log(`gp-1124-no-empty-feedback-wrong: ${pass} pass, ${fail} fail`);
