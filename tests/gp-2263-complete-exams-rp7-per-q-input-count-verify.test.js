// gp-2263: RP7 per-question input counts snapshot (cross-check against 2187)
const d=require('../data/retake-practice-7.json');
const EXP={1:3,2:3,3:7,4:1,5:3,6:2,7:1,8:1,9:1,10:2,11:1,12:6,13:5,14:3,15:2};
let pass=0,fail=0;
...
console.log('gp-2263-rp7-per-q-inputs:',pass+' pass, '+fail+' fail');
