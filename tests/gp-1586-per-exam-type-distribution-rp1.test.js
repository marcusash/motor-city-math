// gp-1586-per-exam-type-distribution-rp1.test.js
// Lock question type distribution for RP1.
...
console.log('gp-1586-rp1-types: ' + typeStr);
console.log('OK -- RP1 type distribution locked: ' + typeStr);
