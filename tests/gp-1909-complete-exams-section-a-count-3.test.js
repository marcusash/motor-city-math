// gp-1909-complete-exams-section-a-3-questions-per-exam.test.js
...
for (const file of RP_FILES) {
  ...
  if (count === 3) pass++;
  else { fail++; failures.push(data.exam_id + ' Section A count=' + count); }
}
console.log('gp-1909-section-a-3: ' + pass + ' pass, ' + fail + ' fail');
