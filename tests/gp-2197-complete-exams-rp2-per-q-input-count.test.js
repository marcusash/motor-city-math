// gp-2197: RP2 per-question input counts snapshot
...
console.log('gp-2197-rp2-per-q-inputs: '+pass+' pass, '+fail+' fail');
if(fail>0){failures.forEach(f=>console.log('  FAIL:',f));process.exit(1);}
console.log('OK -- RP2 per-question input counts snapshot locked');
