// gp-2068-complete-exams-section-d-count-2.test.js
...
for (const file of RP_FILES) {
  ...
  if (count === 2) pass++;
  else { fail++; failures.push(data.exam_id + ' section_D=' + count); }
}
console.log('gp-2068-section-d-count: ' + pass + ' pass, ' + fail + ' fail');
