// gp-1707-complete-exams-all-q-have-section.test.js
// Every question in every complete exam must have a section field (A/B/C/D).
...
console.log('gp-1707-all-q-have-section: ' + pass + ' pass, ' + fail + ' fail');
