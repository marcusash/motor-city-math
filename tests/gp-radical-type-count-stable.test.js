// gp-radical-type-count-stable.test.js — regression: radical type should be exactly 21
...
console.log(`gp-radical-type-count-stable: ${count} ${TYPE} questions (baseline: ${BASELINE})`);
if (count !== BASELINE) {
