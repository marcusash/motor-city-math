// gp-1142-graph-tolerance-positive.test.js
...
for (const file of RP_FILES) {
  ...
  for (const q of data.questions.filter(q => q.graph)) {
    ...
    else { fail++; failures.push(file + ': ' + q.id + ' tolerance=' + q.graph.tolerance); }
  }
}
console.log('gp-1142-graph-tolerance-positive: ' + pass + ' pass, ' + fail + ' fail');
