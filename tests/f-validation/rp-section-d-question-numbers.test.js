// rp-section-d-question-numbers test
// Section D questions should be numbered 14-15 (after section A=1-3, B=4-11, C=12-13)
...
console.log('\u{1F3C0} rp-section-d-question-numbers.test.js\n');
...
console.log('\n' + '='.repeat(50));
console.log('rp-section-d-question-numbers: ' + (pass+fail) + ' checks, ' + pass + ' pass, ' + fail + ' fail');
