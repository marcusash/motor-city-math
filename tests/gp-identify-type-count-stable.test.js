// gp-identify-type-count-stable.test.js — regression: identify type should be exactly 21
...
console.log(`gp-identify-type-count-stable: ${count} ${TYPE} questions (baseline: ${BASELINE})`);
if (count !== BASELINE) {
