// gp-1671-complete-exams-dropdown-has-options.test.js
// All dropdown inputs must have a non-empty options array.
...
console.log('gp-1671-dropdown-has-options: ' + pass + ' pass, ' + fail + ' fail');
if (failures.length) { failures.slice(0,5).forEach(f => console.log('  FAIL:', f)); process.exit(1); }
console.log('OK -- all dropdown inputs have >=2 options (' + pass + ' checked)');
