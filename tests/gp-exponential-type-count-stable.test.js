// gp-exponential-type-count-stable.test.js — regression: exponential type should be exactly 28
...
console.log(`gp-exponential-type-count-stable: ${count} ${TYPE} questions (baseline: ${BASELINE})`);
if (count !== BASELINE) {
